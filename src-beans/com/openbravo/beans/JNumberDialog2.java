 ...
 * @author  adrian
 */
public class JNumberDialog2 extends javax.swing.JDialog {
    ...
    public JNumberDialog2(java.awt.Frame parent, boolean modal, ProductInfoExt p) {
        super(parent, modal);
        init(p);
    }
    
    /** Creates new form JNumberDialog */
    public JNumberDialog2(java.awt.Dialog parent, boolean modal, ProductInfoExt p) {
        super(parent, modal);
        init(p);
    }
    
    private void init(ProductInfoExt p) {
    ...
    public static Double showEditNumber(Component parent, String title, String message, Icon icon, ProductInfoExt p) {
        
        Window window = SwingUtilities.windowForComponent(parent);
        
        JNumberDialog2 myMsg;
        if (window instanceof Frame) { 
            myMsg = new JNumberDialog2((Frame) window, true,p);
        } else {
            myMsg = new JNumberDialog2((Dialog) window, true,p);
        }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Monto", "Peso" }));
        ...
        m_jKeys.setPreferredSize(new java.awt.Dimension(194, 230));
        jPanel3.add(m_jKeys);
    ...
    private void jcmdOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcmdOKActionPerformed
      ...
      this.m_value = m_jnumber.getDoubleValue() / prod.getPriceSell();
    } else {
