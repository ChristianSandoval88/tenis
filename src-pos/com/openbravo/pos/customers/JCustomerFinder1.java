 ...
 * @author  adrianromero
 */
public class JCustomerFinder1 extends javax.swing.JDialog implements EditorCreator {

    private CustomerInfo selectedCustomer;
    private ListProvider lpr;
   
    /** Creates new form JCustomerFinder */
    private JCustomerFinder1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }

    /** Creates new form JCustomerFinder */
    private JCustomerFinder1(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    }
    
    public static JCustomerFinder1 getCustomerFinder(Component parent, DataLogicCustomers dlCustomers) {
        Window window = getWindow(parent);
        
        JCustomerFinder1 myMsg;
        if (window instanceof Frame) { 
            myMsg = new JCustomerFinder1((Frame) window, true);
        } else {
            myMsg = new JCustomerFinder1((Dialog) window, true);
        }
    ...
    private void init(DataLogicCustomers dlCustomers) {
        ...
        lpr = new ListProviderCreator(dlCustomers.getCustomerList1(), this);
