 ...
 * @author adrianromero
 */
public class JPanelCloseMoney2 extends JPanel implements JPanelView, BeanFactoryApp {
    ...
    {
        // LoadData
        m_PaymentsToClose = PaymentsModel2.loadInstance(m_App,2);
    ...
    private void initComponents() {
        ...
        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder(AppLocal.getIntString("label.paymentstitle"))); // NOI18N
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(m_jScrollTableTicket2, javax.swing.GroupLayout.DEFAULT_SIZE, 458, Short.MAX_VALUE))
        );
        jPanel8Layout.setVerticalGroup(
            jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel8Layout.createSequentialGroup()
                .addComponent(m_jScrollTableTicket2, javax.swing.GroupLayout.DEFAULT_SIZE, 276, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(m_jScrollTableTicket1, javax.swing.GroupLayout.PREFERRED_SIZE, 308, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void m_jCloseCashActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jCloseCashActionPerformed
        ...
        if (res == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                props.put("mail.smtp.user", "pdvgdl@gmail.com");
                props.put("mail.smtp.password", "1default1");
                props.put("mail.smtp.port", "587");

                Session session = Session.getInstance(props, new GMailAuthenticator("pdvgdl@gmail.com", "1default1"));

                try {
                    Message message = new MimeMessage(session);
                    message.setFrom(new InternetAddress("pdvgdl@gmail.com"));
                    message.setRecipients(Message.RecipientType.TO,InternetAddress.parse("fecort1@hotmail.com"));
                    message.setSubject("Cierre de caja. Fecha: "+Formats.TIMESTAMP.formatValue(dNow));
                    String body
                    = "<html><table><tr><td colspan=\"8\">*REPORTE DE CIERRE DE CAJA.</td></tr>"
                    ...
                    transport.connect("smtp.gmail.com", 587, "pdvgdl@gmail.com", "1default1");
                    message.saveChanges();
...
/*        FindTicketsInfo selectedTicket = new FindTicketsInfo(Integer.parseInt((String)valueAt),0,m_dlSales);
