...
public class JTicketsBagSharedList2 extends javax.swing.JDialog {
    
    private String m_sDialogTicket;
    
    /** Creates new form JTicketsBagSharedList */
    private JTicketsBagSharedList2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    }
    /** Creates new form JTicketsBagSharedList */
    private JTicketsBagSharedList2(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    }  
    ...
    public static JTicketsBagSharedList2 newJDialog(JTicketsBagShared2 ticketsbagshared) {
        
        Window window = getWindow(ticketsbagshared);
        JTicketsBagSharedList2 mydialog;
        if (window instanceof Frame) { 
            mydialog = new JTicketsBagSharedList2((Frame) window, true);
        } else {
            mydialog = new JTicketsBagSharedList2((Dialog) window, true);
        } 
        ...
        public JButtonTicket(SharedTicketInfo ticket){
            ...
            addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent evt) {
                    ...
                    // y oculto la ventana
                    JTicketsBagSharedList2.this.setVisible(false);
                }
            });
