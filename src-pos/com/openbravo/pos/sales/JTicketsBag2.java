...
import com.openbravo.pos.sales.shared.JTicketsBagShared2;

public abstract class JTicketsBag2 extends JPanel {
    ...
    public JTicketsBag2(AppView oApp, TicketsEditor panelticket) {        
        m_App = oApp;     
    ...
    public abstract void deleteTicket2();
    protected abstract JComponent getBagComponent();
    protected abstract JComponent getNullComponent();
    
    public static JTicketsBag2 createTicketsBag(String sName, AppView app, TicketsEditor panelticket) {
        
        //if ("standard".equals(sName)) {
            // return new JTicketsBagMulti(oApp, user, panelticket);
            return new JTicketsBagShared2(app, panelticket);
        //} 
