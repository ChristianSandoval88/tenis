...
public class MovementReason extends ComboItemLocal {
    ...
    public static final MovementReason IN_NOCOUNT = new MovementReason(+5, "stock.in.nocount");
    ...
    public static final MovementReason OUT_NOCOUNT = new MovementReason(-5, "stock.out.nocount");
