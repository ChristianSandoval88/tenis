...
public abstract class JPaymentSelect extends javax.swing.JDialog 
    ...
    public class JPaymentFreeCreator_1 implements JPaymentCreator {
        public JPaymentInterface createJPayment() {
            return new JPaymentFree_1(JPaymentSelect.this);
        }
        public String getKey() { return "payment.free1"; }
        public String getLabelKey() { return "tab.free1"; }
        public String getIconKey() { return "/com/openbravo/images/package_toys.png"; }
    }
