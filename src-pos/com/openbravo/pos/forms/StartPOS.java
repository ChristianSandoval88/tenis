        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                /*int seleccion = JOptionPane.showOptionDialog( null,"Seleccione una opcion",
                         ...
                         new Object[] { "Tienda 1 Soriana", "Tienda 2 Chedraui"
                         },"Tienda 1 Soriana");
                if (seleccion != -1){
                    
                    if(seleccion==0)
                    {
                        config.setProperty("db.URL", "jdbc:mysql://40.87.93.21/soriana?autoReconnect=true&failOverReadOnly=false");
                        config.setProperty("machine.hostname", "SORIANA");
                    }
                    else if(seleccion==1)
                    {
