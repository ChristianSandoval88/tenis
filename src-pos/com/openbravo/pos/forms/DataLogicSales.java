...
public CustomerInfoExt findCustomerExtById(String id)
 ...
 public List<ProductInfoExt> getProductFilter(String filter) throws BasicException  {
    ...
    public final SentenceList getCategoriesList2() {
        return new StaticSentence(s
            , "SELECT '0', '', null"
            , null
            , CategoryInfo.getSerializerRead());
        ...
        Transaction t = new Transaction(s) {
            public Object transact() throws BasicException {
                ...
                SentenceExec ticketlineinsert = new PreparedSentence(s
                    , "INSERT INTO TICKETLINES (ID,TICKET, LINE, PRODUCT, ATTRIBUTESETINSTANCE_ID, UNITS, PRICE, TAXID, ATTRIBUTES,TOTAL) VALUES (UUID(),?, ?, ?, ?, ?, ?, ?, ?,?)"
    ...
    public final SentenceExec getStockDiaryInsert() {
        return new SentenceExecTransaction(s) {
            public int execInTransaction(Object params) throws BasicException {
                ...
                return new PreparedSentence(s
                    , "INSERT INTO STOCKDIARY (ID, DATENEW, REASON, LOCATION, PRODUCT, ATTRIBUTESETINSTANCE_ID, UNITS, PRICE, ACTIVECASH) VALUES (?, NOW(), ?, ?, ?, ?, ?, ?, ?)"
                    , new SerializerWriteBasicExt(stockdiaryDatas, new int[] {0, 2, 3, 4, 5, 6, 7,8})).exec(params);
            }
        };
    }
